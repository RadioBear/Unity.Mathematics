...
{
    [TestFixture]
    public class TestFix64p2x4
    {
        [TestCompiler]
        public static void fix64p2x4_zero()
        {
            TestUtils.AreEqual(fix64p2x4.zero.c0.x, fix64p.zero);
            TestUtils.AreEqual(fix64p2x4.zero.c0.y, fix64p.zero);
            TestUtils.AreEqual(fix64p2x4.zero.c1.x, fix64p.zero);
            TestUtils.AreEqual(fix64p2x4.zero.c1.y, fix64p.zero);
            TestUtils.AreEqual(fix64p2x4.zero.c2.x, fix64p.zero);
            TestUtils.AreEqual(fix64p2x4.zero.c2.y, fix64p.zero);
            TestUtils.AreEqual(fix64p2x4.zero.c3.x, fix64p.zero);
            TestUtils.AreEqual(fix64p2x4.zero.c3.y, fix64p.zero);
        }
