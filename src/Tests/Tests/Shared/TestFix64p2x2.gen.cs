...
{
    [TestFixture]
    public class TestFix64p2x2
    {
        [TestCompiler]
        public static void fix64p2x2_zero()
        {
            TestUtils.AreEqual(fix64p2x2.zero.c0.x, fix64p.zero);
            TestUtils.AreEqual(fix64p2x2.zero.c0.y, fix64p.zero);
            TestUtils.AreEqual(fix64p2x2.zero.c1.x, fix64p.zero);
            TestUtils.AreEqual(fix64p2x2.zero.c1.y, fix64p.zero);
        }

        [TestCompiler]
        public static void fix64p2x2_identity()
        {
            TestUtils.AreEqual(fix64p2x2.identity.c0.x, fix64p.One);
            TestUtils.AreEqual(fix64p2x2.identity.c0.y, fix64p.zero);
            TestUtils.AreEqual(fix64p2x2.identity.c1.x, fix64p.zero);
            TestUtils.AreEqual(fix64p2x2.identity.c1.y, fix64p.One);
        }
