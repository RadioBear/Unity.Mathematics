...
{
    [TestFixture]
    public class TestFix64p4x4
    {
        [TestCompiler]
        public static void fix64p4x4_zero()
        {
            TestUtils.AreEqual(fix64p4x4.zero.c0.x, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c0.y, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c0.z, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c0.w, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c1.x, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c1.y, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c1.z, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c1.w, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c2.x, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c2.y, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c2.z, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c2.w, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c3.x, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c3.y, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c3.z, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.zero.c3.w, fix64p.zero);
        }

        [TestCompiler]
        public static void fix64p4x4_identity()
        {
            TestUtils.AreEqual(fix64p4x4.identity.c0.x, fix64p.One);
            TestUtils.AreEqual(fix64p4x4.identity.c0.y, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c0.z, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c0.w, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c1.x, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c1.y, fix64p.One);
            TestUtils.AreEqual(fix64p4x4.identity.c1.z, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c1.w, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c2.x, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c2.y, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c2.z, fix64p.One);
            TestUtils.AreEqual(fix64p4x4.identity.c2.w, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c3.x, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c3.y, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c3.z, fix64p.zero);
            TestUtils.AreEqual(fix64p4x4.identity.c3.w, fix64p.One);
        }
